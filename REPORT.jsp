...
<report name="FINAlReport" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="Datee" datatype="date" precision="10"
     defaultWidth="0" defaultHeight="0">
      <listOfValues restrictToList="yes">
        <selectStatement hideFirstColumn="no">
        <![CDATA[SELECT ALL PAYMENT.PAYMENT_DATE
FROM PAYMENT ]]>
        </selectStatement>
      </listOfValues>
    </userParameter>
    <dataSource name="Q_1">
      <select canParse="no">
      <![CDATA[SELECT ALL TICKET.TICKET_ID, 
TICKET.CLASS_TYPE, PAYMENT.PAYMENT_DATE, PAYMENT.PAYMENT_AMOUNT
FROM PAYMENT, TICKET
WHERE (TICKET.PAYMENT_CODE = PAYMENT.PAYMENT_CODE) 
AND PAYMENT.PAYMENT_DATE < = :Datee ; ]]>
      </select>
      ...
      <group name="G_TICKET_ID">
        ...
        <dataItem name="TICKET_ID" oracleDatatype="number" columnOrder="11"
         ...
         columnFlags="1" defaultLabel="Ticket Id">
          <dataDescriptor expression="TICKET_ID"
           descriptiveExpression="TICKET_ID" order="1" oracleDatatype="number"
           width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CLASS_TYPE" datatype="vchar2" columnOrder="12"
         width="12" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Class Type">
          <dataDescriptor expression="CLASS_TYPE"
           descriptiveExpression="CLASS_TYPE" order="2" width="12"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PAYMENT_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="1" defaultLabel="Payment Date">
          <dataDescriptor expression="PAYMENT_DATE"
           descriptiveExpression="PAYMENT_DATE" order="3"
           oracleDatatype="date" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PAYMENT_AMOUNT" oracleDatatype="number"
         columnOrder="14" width="22" defaultWidth="80000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Payment Amount">
          <dataDescriptor expression="PAYMENT_AMOUNT"
           descriptiveExpression="PAYMENT_AMOUNT" order="4"
           oracleDatatype="number" width="22" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumPAYMENT_AMOUNTPerReport" source="PAYMENT_AMOUNT"
     function="sum" width="22" precision="6" reset="report" compute="report"
     defaultWidth="80000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Total:">
  ...
  <section name="main">
    <body>
      <frame name="M_G_TICKET_ID_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.87500" height="0.56250"
        />
        ...
        <repeatingFrame name="R_G_TICKET_ID" source="G_TICKET_ID"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.18750" width="5.87500"
           height="0.18750"/>
          ...
          <field name="F_CLASS_TYPE" source="CLASS_TYPE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
          ...
          <field name="F_PAYMENT_AMOUNT" source="PAYMENT_AMOUNT"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.68750" y="0.18750" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_TICKET_ID_FTR">
          <geometryInfo x="0.00000" y="0.37500" width="5.87500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_SumPAYMENT_AMOUNTPerReport"
           source="SumPAYMENT_AMOUNTPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="4.68750" y="0.37500" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_TICKET_ID_HDR">
          <geometryInfo x="0.00000" y="0.00000" width="5.87500"
           height="0.18750"/>
          ...
          <text name="B_CLASS_TYPE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.81250" y="0.00000" width="1.50000"
             height="0.18750"/>
          ...
          <text name="B_PAYMENT_DATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.31250" y="0.00000" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_PAYMENT_AMOUNT" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.68750" y="0.00000" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
<rw:dataArea id="MGTICKETIDGRPFR235">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBTICKETID235" asArray="no"/> class="OraColumnHeader"> Ticket Id </th>
   <th <rw:id id="HBCLASSTYPE235" asArray="no"/> class="OraColumnHeader"> Class Type </th>
   <th <rw:id id="HBPAYMENTDATE235" asArray="no"/> class="OraColumnHeader"> Payment Date </th>
   <th <rw:id id="HBPAYMENTAMOUNT235" asArray="no"/> class="OraColumnHeader"> Payment Amount </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGTICKETID2351" src="G_TICKET_ID">
   <tr>
    <td <rw:headers id="HFTICKETID235" src="HBTICKETID235"/> class="OraCellNumber"><rw:field id="FTICKETID235" src="TICKET_ID" nullValue="&nbsp;"> F_TICKET_ID </rw:field></td>
    <td <rw:headers id="HFCLASSTYPE235" src="HBCLASSTYPE235"/> class="OraCellText"><rw:field id="FCLASSTYPE235" src="CLASS_TYPE" nullValue="&nbsp;"> F_CLASS_TYPE </rw:field></td>
    <td <rw:headers id="HFPAYMENTDATE235" src="HBPAYMENTDATE235"/> class="OraCellText"><rw:field id="FPAYMENTDATE235" src="PAYMENT_DATE" nullValue="&nbsp;"> F_PAYMENT_DATE </rw:field></td>
    <td <rw:headers id="HFPAYMENTAMOUNT235" src="HBPAYMENTAMOUNT235"/> class="OraCellNumber"><rw:field id="FPAYMENTAMOUNT235" src="PAYMENT_AMOUNT" nullValue="&nbsp;"> F_PAYMENT_AMOUNT </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumPAYMENTAMOUNTPerReport235" src="HBPAYMENTAMOUNT235"/> class="OraTotalNumber">Total: <rw:field id="FSumPAYMENTAMOUNTPerReport235" src="SumPAYMENT_AMOUNTPerReport" nullValue="&nbsp;"> F_SumPAYMENT_AMOUNTPerReport </rw:field></td>
 </tr>
</table>
</rw:dataArea> <!-- id="MGTICKETIDGRPFR235" -->
